<template>
  <svg
viewBox="0 0 960 540" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1"
    class="min-h-screen min-w-screen fixed left-0" :style="{ bottom: '-10rem' }" preserveAspectRatio="none">
    <rect x="0" y="0" width="960px" height="540px" fill="var(--p-surface-ground)"/>
    <path
      ...
      fill="var(--p-orange-500)" strokeLinecap="round" strokeLinejoin="miter"/>
  </svg>
  <div class="px-5 min-h-screen flex justify-justify-center items-center">

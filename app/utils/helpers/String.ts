...
import { IMessage } from '@/utils/types/Form';
...
export const formatCurrency = (
  ...
  //TODO: adapt composable lang
  // const { defaultLocale, defaultCurrency } = useLang();

  // if (!locale) locale = defaultLocale.value;
  if (!locale) locale = 'en-US'; // Default to 'en-US' if
  // if (!currency) currency = defaultCurrency.value;
  if (!currency) currency = 'USD'; // Default to 'USD' if
